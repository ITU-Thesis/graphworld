...
class Subgraph:
    '''
    Build a subgraph given the node indices.
    Note this does not presetve the edge attributes.
    '''
    ...
    @property
    def new_to_old_node_indices(self):
    ...
    @property
    def old_to_new_node_indices(self):
